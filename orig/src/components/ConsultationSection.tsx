  ...
  return (
    <section id="consultation" className="py-24 px-4 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-6xl font-bold leading-tight">
              ЛИЧНАЯ <br />
              <span className="text-quantum-amber">ОНЛАЙН-КОНСУЛЬТАЦИЯ</span>
            </h2>

            <p className="text-xl text-quantum-ivory/80 font-light leading-relaxed max-w-xl">
              Глубокая работа с твоим запросом. Мы найдем корень проблемы и создадим пошаговый план твоего квантового перехода.
            </p>

            <div className="flex items-center gap-4 pt-2">
              <div className="text-4xl font-display font-bold text-quantum-amber">8 000 ₽</div>
            ...
            <div className="space-y-6 pt-4">
              {[
                ...
                <div key={i} className="flex gap-4 items-start group">
                  ...
                  <div>
                    <h4 className="font-display text-lg font-bold text-quantum-ivory mb-1">{item.title}</h4>
                    <p className="text-quantum-ivory/60 font-light">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          >
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[40px] p-8 md:p-12 shadow-2xl relative overflow-hidden group">
              ...
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  ...
                  >
                    <h3 className="font-display text-2xl font-bold text-quantum-ivory mb-2">Запись на консультацию</h3>
                    <p className="text-quantum-ivory/60 mb-6 font-light text-sm">Выбери удобный день и время для встречи.</p>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-widest font-bold text-white/60">Спецпредложение</p>
                  <p className="font-display font-bold text-white">Первая сессия -30%</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <div className="max-w-4xl mx-auto px-4 mt-16 relative z-10">
        ...
        >
          <h3 className="font-display text-2xl font-bold text-quantum-ivory mb-4">Есть вопрос, но не знаешь, нужна ли тебе сессия?</h3>
          <p className="text-quantum-ivory/70 mb-8 font-light">
            Напиши мне в Telegram и кратко опиши свою ситуацию. Я помогу тебе понять, какой формат работы будет наиболее эффективным для твоего запроса.
          </p>
          <a 
            href="https://t.me/viktoria_neustroeva" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-[#229ED9] text-white font-bold hover:scale-105 transition-all shadow-lg shadow-[#229ED9]/20"
          >
            <Send size={20} />
