        ...
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="bg-gray-800 overflow-hidden shadow-sm sm:rounded-3xl border border-gray-700">
                        ...
                        <div className="flex border-b border-gray-700">
                            <button
                                ...
                                className={`px-8 py-4 text-sm font-bold uppercase tracking-widest transition-colors flex items-center gap-2 ${
                                    activeTab === 'pages' ? 'bg-gray-700 text-quantum-amber border-b-2 border-quantum-amber' : 'text-gray-400 hover:text-gray-200'
                                }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-8 py-4 text-sm font-bold uppercase tracking-widest transition-colors flex items-center gap-2 ${
                                    activeTab === 'global' ? 'bg-gray-700 text-quantum-amber border-b-2 border-quantum-amber' : 'text-gray-400 hover:text-gray-200'
                                }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-8 py-4 text-sm font-bold uppercase tracking-widest transition-colors flex items-center gap-2 ${
                                    activeTab === 'files' ? 'bg-gray-700 text-quantum-amber border-b-2 border-quantum-amber' : 'text-gray-400 hover:text-gray-200'
                                }`}
                            >
                        ...
                        <div className="p-8">
                                ...
                                <form onSubmit={submitGlobal} className="space-y-8 max-w-4xl">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <textarea 
                                            ...
                                            rows="6"
                                            className="w-full bg-gray-900 border-gray-700 rounded-2xl text-sm font-mono text-gray-300 focus:ring-quantum-amber focus:border-quantum-amber"
                            ...
                            {activeTab === 'files' && (
                                <div className="space-y-12 max-w-4xl">
                                    <form onSubmit={submitGlobal} className="space-y-4">
                                        ...
                                        <div className="flex justify-end">
                                            <button 
                                                type="submit" 
                                                disabled={globalForm.processing}
                                                className="bg-gray-700 text-white px-6 py-2 rounded-xl font-bold uppercase text-[10px] tracking-widest hover:bg-gray-600"
                                            >
                                                Обновить robots.txt
                                            </button>
                                        </div>
                                    ...
                                    <div className="p-8 bg-gray-900/50 border border-gray-700 rounded-3xl space-y-6">
                                        ...
                                        <div className="text-xs text-gray-400 bg-black/30 p-4 rounded-xl border border-gray-800">
...
function PageSeoForm({ page, initialData }) {
    ...
    return (
        <div className="bg-gray-900/30 border border-gray-700 rounded-3xl overflow-hidden">
            <div className="px-6 py-4 bg-gray-800/50 border-b border-gray-700 flex items-center justify-between">
                <h3 className="font-bold text-gray-200 flex items-center gap-2 capitalize">
            ...
            <form onSubmit={submit} className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-[10px] uppercase font-bold text-gray-500 ml-1">Meta Title</label>
                            <input 
                                type="text" 
                                value={data.title}
                    ...
                    {/* Open Graph */}
                    <div className="space-y-4 bg-gray-800/20 p-4 rounded-2xl border border-gray-700/50">
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] uppercase font-bold text-gray-500 ml-1">OG Title</label>
                            <input 
                                type="text" 
                                value={data.og_title}
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] uppercase font-bold text-gray-500 ml-1">OG Image</label>
                            <div className="flex items-center gap-4">
                                {initialData?.og_image && (
                                    <div className="w-16 h-10 bg-gray-800 rounded border border-gray-700 overflow-hidden">
                                ...
                                <input 
                                    ...
                                    className="block w-full text-[10px] text-gray-400 file:mr-4 file:py-1 file:px-3 file:rounded-full file:border-0 file:text-[10px] file:font-bold file:bg-gray-700 file:text-gray-200 hover:file:bg-gray-600"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-2">
                    <label className="text-[10px] uppercase font-bold text-gray-500 ml-1">Additional Meta Tags / Scripts</label>
                    <textarea 
                        value={data.additional_tags}
                        onChange={e => setData('additional_tags', e.target.value)}
                        rows="3"
                        className="w-full bg-gray-800 border-gray-700 rounded-xl text-sm text-gray-200 font-mono focus:ring-quantum-amber p-4"
                ...
                <div className="flex justify-end pt-4 border-t border-gray-700/50">
                    <button 
                        type="submit" 
                        disabled={processing}
                        className="bg-gray-700 text-white px-6 py-2 rounded-xl font-bold uppercase text-[10px] tracking-widest hover:bg-quantum-amber hover:text-quantum-emerald transition-all disabled:opacity-50"
                    >
