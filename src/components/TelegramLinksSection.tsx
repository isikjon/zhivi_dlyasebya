    ...
    <section className="py-12 px-4 relative z-10">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <EditableLink section="Telegram" itemKey="channel_1" defaultHref="https://t.me/liveyouresse" className="block">
            <motion.div
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-6">
                ...
                <div>
                  <h3 className="font-display text-2xl font-bold text-quantum-ivory mb-2 group-hover:text-quantum-amber transition-colors">
                    <EditableText section="Telegram" itemKey="channel_1_title">Больше трансформаций</EditableText>
                  </h3>
                  <p className="text-quantum-ivory/60 font-light">
                    <EditableText section="Telegram" itemKey="channel_1_desc">в моем Telegram-канале</EditableText>
                  </p>
                </div>
              </div>
          ...
          <EditableLink section="Telegram" itemKey="channel_2" defaultHref="https://t.me/neustroevaMeditation" className="block">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-6">
                ...
                <div>
                  <h3 className="font-display text-2xl font-bold text-quantum-ivory mb-2 group-hover:text-quantum-rose transition-colors">
                    <EditableText section="Telegram" itemKey="channel_2_title">Исцеляющие медитации</EditableText>
                  </h3>
                  <p className="text-quantum-ivory/60 font-light">
                    <EditableText section="Telegram" itemKey="channel_2_desc">в отдельном Telegram-канале</EditableText>
                  </p>
                </div>
              </div>
              <div className="relative z-10 shrink-0 self-end sm:self-auto">
